...
<script type="text/javascript">
		...
		$.post("",
				...
				function(data){
				  ...
				  for(var i=0;i<sort.length;i++){
					  sortElem.applent("${sort.name}</option>");
				  } 
		}); */
	}
	//删除按钮
	function deleteDep(){
		...
		if(str!=""){
			...
			$.ajax({
    	    	type: 'post',
    	    	url: '${pageContext.request.contextPath}/admin/deleteDiary',
    	    	data: {'data':str},
    	    	success: function(data) {
    	    		if(data!="0"){
	       			 	layer.alert("您已成功删除"+data+"篇日记");
	       			 	window.location.href="${pageContext.request.contextPath}/admin/openDiary";
    	    		}  
    	    		else{
    	    			layer.alert("删除失败");
    	    		}   	        		
...
<body>
    ...
    <div class="rightinfo">
     <form action="${pageContext.request.contextPath}/admin/openDiary" method="get" id="form1">
		...
		<div class="row cl" style="display:inline-block;margin-bottom:-10px;">
...
<br/><hr>
    ...
    <div class="tools">
    	<ul class="toolbar">
	        <li onclick="deleteDep()" ><span><img src="${pageContext.request.contextPath }/public/img/t03.png" /></span>删除日记</li>
        </ul>
    </div>

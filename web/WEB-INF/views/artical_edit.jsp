...
<script type="text/javascript" src="public/ueditor/utf8-jsp/ueditor.config.js"></script>
<script type="text/javascript" src="public/ueditor/utf8-jsp/ueditor.all.js"></script>

</head>

<body id="content_area" style="width:99%">
	<form method="post" action="storeArtical" name="frmMain" id="frmMain" style="float:left;width:99%">
						...
						<div id="Main">
							...
							<div id="Editor_Edit">
								...
								<div style="margin:10px">
									<!-- 加载编辑器的容器 -->
									<script id="container" name="content1" type="text/plain"> 请输入您的文章</script>
									<!-- 配置文件 -->
									<script type="text/javascript"
											...
											<tbody>
												<tr>
													<c:forEach items="${userSort}" var="sort">
														<td><input type="radio" name="sId" value="${sort.id } ">${sort.name }</td>
													</c:forEach> 
												</tr>
											</tbody>
										</table>
											...
											<table style="width:95%;">
												<tbody>
													<tr>
														...
														<td><input type="radio" name="isopen"
															value="3" />所有人可见</td>
													</tr>
												</tbody>
											</table>
		...
		<input type="hidden"  id="status" name ="status" value=""/>
						...
						<input type="button" id="articalPost" value="发布"
								onclick="tj(1)" class="Button"> 
								
								<input
								type="button" id="articalDraft" value="存为草稿"
								onclick="tj(2)" class="Button"> 
